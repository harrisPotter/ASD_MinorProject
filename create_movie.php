<?php
    ...
    if (isset($_POST['add_btn'])) {
        ...
        if(!has_presence($imagename)) {
            ...
            $errors[$imagename] = "Please Select Image";
        }else {
        ...
        // validate input
        $fields_required = array("movie_name", "director_name", "actor_name", "synopsis", "price");
        ...
        if (empty($errors)) {
            ...
            $sql = "INSERT INTO movie_info(movie_name, movie_image, price, actor, director, genre, synopsis) values('$moviename', '$image_file', $price, '$actor', '$director', '$str_genre', '$synopsis')";
    ...
    <body>
        ...
        <div class="uk-position-center uk-card uk-card-default uk-card-large uk-card-body">
            ...
            <form class="uk-form-horizontal" action="create_movie.php" method="post" enctype="multipart/form-data">
                ...
                <div class="uk-margin" uk-margin>
                    <label class="uk-form-label" style="width:110px">Price</label>
                    <div class="uk-form-controls" style="margin-left:130px;">
                        <input class="uk-input" style="width:200px" name="price" type="text" placeholder="price" value="<?php echo !empty($price)?$price:'';?>">
