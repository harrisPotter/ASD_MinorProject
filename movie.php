            ...
            <div class="row">
                <table class="uk-table uk-table-hover uk-table-divider">
                   ...
                   while ($row = mysqli_fetch_assoc($query_result)) {
                       ...
                       echo '<td width=250>';
                       echo '<a class="btn" href="read_movie.php?id='.$row['movie_id'].'">Read</a>';
                       echo ' ';
                       echo '<a class="btn btn-success" href="edit_movie.php?id='.$row['movie_id'].'">Edit</a>';
                       echo ' ';
                       echo '<a class="btn btn-danger" href="delete_movie.php?id='.$row['movie_id'].'">Delete</a>';
                       echo '</td>';
                       echo '</tr>';
                   }
