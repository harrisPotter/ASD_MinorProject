        ...
        <nav class="uk-navbar-container" uk-navbar style="position: relative; z-index: 980;">
            <div class="uk-navbar-left">
                ...
                <ul class="uk-navbar-nav uk-subnav-divider">
                    <li><a href="login.php" uk-toggle><span uk-icon = "icon: sign-in"></span>Login</a></li>

                    <li><a href="create_from_home.php" uk-toggle><span uk-icon = "icon: pull"></span>Register</a></li>
