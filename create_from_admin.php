    ...
    <body>
        ...
        <div class="uk-position-center uk-card uk-card-default uk-card-large uk-card-body">
            ...
            <div class="uk-flex uk-flex-center">
                ...
                <h3 class="uk-heading-line uk-text-center"><span>Register</span></h3>
            </div>

            <form class="uk-form-horizontal" action="create_from_admin.php" method="post">
                ...
                <div class="uk-flex uk-flex-center">
                    <div class="form-actions">
                        ...
                        <a class="uk-button uk-button-danger" href="index.php">Back</a>
                    </div>
                </div>
